...
// let current_users: string[] = ["Daniyal", "Ali", "Khurram", "Sami", "Admin"];
// let new_users: string[] = ["Noor", "Daniyal", "Saif", "Ali", "Admin"];
...
//  Question 34 Pizzas
// let pizzas: string[] = ['Pepperoni','Fajita','Ranch'];
...
// Question 35 Animals
// let animals: string[] = ['Rabbit','Cow','Horse'];
...
//     let greatMagicians: string[] =[]; magicians.forEach(magician =>{
...
// make_sandwich("Lettuce","Club","Tomato");
// make_sandwich("Double Patty","Double Chees","Mustard","Mayo Garlic");
...
//         }
//     }
//   let myCar: car=make_car("Toyota", "Corolla", {"color": "red", "year": 2020})
//   console.log(myCar);